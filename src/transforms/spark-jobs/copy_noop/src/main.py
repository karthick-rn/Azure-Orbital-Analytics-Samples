...
parser = argparse.ArgumentParser(
    description='Arguments required to run copy noop function')
...
parser.add_argument('--src_container', type=str, required=False,
                    help='Source container in Azure Storage')
parser.add_argument('--src_fileshare', type=str, required=False,
                    help='Source File share in Azure Storage')
parser.add_argument('--src_folder', default=None, required=True,
                    help='Source folder path in Azure Storage Container or File Share')

parser.add_argument('--dst_container', type=str, required=False,
                    help='Destination container in Azure Storage')
parser.add_argument('--dst_fileshare', type=str, required=False,
                    help='Destination File share in Azure Storage')
parser.add_argument('--dst_folder', default=None, required=True,
                    help='Destination folder path in Azure Storage Container or File Share')

parser.add_argument('--folders_to_create', action='append',
                    required=False, help='Folders to create in container or file share')
...
if __name__ == "__main__":
    ...
    copy(src_mounted_path, src_unmounted_path, dst_mounted_path,
         dst_unmounted_path, args.dst_folder, args.folders_to_create)
